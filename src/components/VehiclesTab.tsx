  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
          <h2 className="text-3xl font-display font-bold text-surface-950 tracking-tight">Frota de Veículos</h2>
          <p className="text-surface-500 mt-1 font-medium">Gerencie as especificações técnicas e proprietários.</p>
        </div>
